...
import { LayoutDashboard, Users, GitBranch, Calendar, HelpCircle } from 'lucide-react'
import { DEFAULT_SETTINGS, type TenantSettings } from '@/lib/types/settings'

const ALL_TABS = [
  { href: '/dashboard', icon: LayoutDashboard, label: 'Home',     color: '#2a52a0', bg: 'rgba(74,157,181,0.10)', flag: null     },
  ...
  { href: '/support',   icon: HelpCircle,       label: 'Support',  color: '#10b981', bg: '#ecfdf5', flag: null                    },
]
