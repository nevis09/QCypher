  ...
  if (done) {
    return (
      <div style={{ ...card, textAlign: 'center' }}>
        ...
        <p style={{ fontWeight: 700, color: '#e8f0fa', fontSize: '17px', marginBottom: '6px' }}>Verify your email</p>
        <p style={{ fontSize: '14px', color: 'rgba(148,180,220,0.75)', lineHeight: 1.6 }}>
          We sent a confirmation link to <strong style={{ color: TEAL }}>{email}</strong>.<br />
  ...
  return (
    <div style={card}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '22px' }}>
        ...
        <span style={{ fontSize: '13px', color: 'rgba(148,180,220,0.5)', fontWeight: 500 }}>or create with email</span>
        <div style={{ flex: 1, height: '1px', background: BORDER }} />
      </div>
      ...
      <p style={{ textAlign: 'center', marginTop: '22px', fontSize: '14px', color: 'rgba(148,180,220,0.65)' }}>
        ...
        <Link href="/auth/login" style={{ color: TEAL, fontWeight: 700, textDecoration: 'none' }}>Sign in</Link>
      </p>
    </div>
  )
}
