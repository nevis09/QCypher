...
export function AddInteractionForm({ contactId }: { contactId: string }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white dark:bg-[hsl(var(--muted))] rounded-2xl border border-[hsl(var(--border))] shadow-soft p-4 space-y-3">
      ...
      <div className="flex justify-end">
        <button
          ...
          className="bg-accent text-white text-sm font-medium px-4 py-1.5 rounded-xl hover:bg-accent-hover transition-colors disabled:opacity-40"
        >
