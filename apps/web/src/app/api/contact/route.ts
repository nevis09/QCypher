  ...
  try {
    ...
    const commonStyles = `
      * { margin: 0; padding: 0; box-sizing: border-box; }
      ...
      .header { background: linear-gradient(135deg, #1e3a8a 0%, #0369a1 100%); padding: 60px 40px; text-align: center; color: white; }
      .logo { font-size: 36px; font-weight: 800; margin-bottom: 16px; letter-spacing: -0.5px; color: #ffffff !important; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Arial, sans-serif; }
      .tagline { font-size: 14px; opacity: 0.92; font-weight: 500; letter-spacing: 0.3px; }
      .content { padding: 50px 40px; }
      .greeting { font-size: 32px; font-weight: 800; margin-bottom: 8px; color: #1e3a8a; }
      .subtitle { font-size: 17px; color: #0369a1; font-weight: 600; margin-bottom: 28px; }
      ...
      .info-section h3 { margin: 0 0 24px 0; font-size: 12px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.6px; color: #1e3a8a; }
      ...
      .info-label { font-size: 11px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.6px; color: #718096; margin-bottom: 6px; }
      .info-value { font-size: 15px; color: #1e3a8a; font-weight: 600; }
      .cta-box { background: linear-gradient(135deg, #1e3a8a 0%, #0369a1 100%); border-radius: 10px; padding: 36px 40px; margin: 32px 0; text-align: center; box-shadow: 0 8px 24px rgba(30, 58, 138, 0.15); }
      .cta-text { color: white; font-size: 15px; margin-bottom: 14px; font-weight: 600; opacity: 0.95; }
      .cta-phone { color: white; font-size: 18px; font-weight: 700; letter-spacing: 0.5px; }
      .footer { padding: 40px; text-align: center; border-top: 1px solid #e2e8f0; background: #fafbfc; font-size: 13px; }
      .footer-branding { font-weight: 700; color: #1e3a8a; margin-bottom: 6px; font-size: 15px; }
