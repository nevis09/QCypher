...
export default function InvitePage({
  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-[hsl(var(--muted))] px-4">
      <div className="w-full max-w-sm bg-white dark:bg-[hsl(var(--muted))] rounded-2xl shadow-card p-8 text-center space-y-4">
        {expired ? (
          <>
          ...
          <>
            ...
            <Link
              href="/auth/login"
              className="inline-block mt-2 bg-accent text-white text-sm font-medium px-5 py-2 rounded-xl hover:bg-accent-hover transition-colors"
            >
              Go to sign in
            </Link>
          </>
