      ...
      <style>{`
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .page-hero-image img {
          ...
          display: block;
          border-radius: 12px;
          -webkit-mask-image: radial-gradient(ellipse 70% 70% at 50% 50%, black 0%, black 50%, transparent 100%);
          mask-image: radial-gradient(ellipse 70% 70% at 50% 50%, black 0%, black 50%, transparent 100%);
        }
        .page-hero h1 {
